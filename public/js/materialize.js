...
(function(factory) {
	...
	function find(selector, context) {
		...
		var elems = classMatch.test(selector)
			...
			: singlet.test(selector) ? context.getElementsByTagName(selector) : context.querySelectorAll(selector);
		return elems;
	}
...
M.checkWithinContainer = function(container, bounding, offset) {
	...
	var containerBottom =
		container === document.body ? Math.max(containerRect.bottom, window.innerHeight) : containerRect.bottom;
	...
	var ga = {
		...
		Q = (function() {
			function a(a, b) {
				return 0 === a || 1 === a
					? a
					: -Math.pow(2, 10 * (a - 1)) * Math.sin(2 * (a - 1 - b / (2 * Math.PI) * Math.asin(1)) * Math.PI / b);
			}
			...
			[
				{
					...
					value: function init(els, options) {
						return _get(Collapsible.__proto__ || Object.getPrototypeOf(Collapsible), 'init', this).call(
							this,
							this,
							els,
							options
			...
			[
				{
					key: 'init',
					value: function init(els, options) {
						return _get(Dropdown.__proto__ || Object.getPrototypeOf(Dropdown), 'init', this).call(
							this,
							this,
							els,
							options
				...
				},
				{
					...
					value: function _animateImageIn() {
						...
						var animOptions = {
							...
							left:
								M.getDocumentScrollLeft() + this.windowWidth / 2 - this.placeholder.offset().left - this.newWidth / 2,
							top:
								M.getDocumentScrollTop() + this.windowHeight / 2 - this.placeholder.offset().top - this.newHeight / 2,
							duration: this.options.inDuration,
							easing: 'easeOutQuad',
							complete: function() {
			...
			[
				{
					key: 'init',
					value: function init(els, options) {
						return _get(Materialbox.__proto__ || Object.getPrototypeOf(Materialbox), 'init', this).call(
							this,
							this,
							els,
							options
			...
			[
				{
					key: 'init',
					value: function init(els, options) {
						return _get(Parallax.__proto__ || Object.getPrototypeOf(Parallax), 'init', this).call(
							this,
							this,
							els,
							options
			...
			[
				{
					key: 'init',
					value: function init(els, options) {
						return _get(Tooltip.__proto__ || Object.getPrototypeOf(Tooltip), 'init', this).call(
							this,
							this,
							els,
							options
       ...
       */
				...
				},
				{
					...
					value: function _animateSidenavIn() {
						...
						if (this.isDragged) {
							slideOutPercent =
								this.options.edge === 'left' ? slideOutPercent + this.percentOpen : slideOutPercent - this.percentOpen;
						}
				...
				},
				{
					...
					value: function _animateSidenavOut() {
						...
						if (this.isDragged) {
							slideOutPercent =
								this.options.edge === 'left' ? endPercent + this.percentOpen : endPercent - this.percentOpen;
						}
			...
			[
				{
					key: 'init',
					value: function init(els, options) {
						return _get(Sidenav.__proto__ || Object.getPrototypeOf(Sidenav), 'init', this).call(
							this,
							this,
							els,
							options
			...
			[
				{
					key: 'init',
					value: function init(els, options) {
						return _get(ScrollSpy.__proto__ || Object.getPrototypeOf(ScrollSpy), 'init', this).call(
							this,
							this,
							els,
							options
			...
			[
				{
					key: 'init',
					value: function init(els, options) {
						return _get(Autocomplete.__proto__ || Object.getPrototypeOf(Autocomplete), 'init', this).call(
							this,
							this,
							els,
							options
			...
			[
				{
					key: 'init',
					value: function init(els, options) {
						return _get(Pushpin.__proto__ || Object.getPrototypeOf(Pushpin), 'init', this).call(
							this,
							this,
							els,
							options
       ...
       */
				...
				},
				{
					...
					value: function renderTitle(instance, c, year, month, refYear, randId) {
						...
						html +=
							'<button class="month-prev' + (prev ? '' : ' is-disabled') + '" type="button">' + leftArrow + '</button>';
			...
			[
				{
					key: 'init',
					value: function init(els, options) {
						return _get(Datepicker.__proto__ || Object.getPrototypeOf(Datepicker), 'init', this).call(
							this,
							this,
							els,
							options
						...
						for (var i = 0; i < 60; i += 5) {
							...
							tick.css({
								left:
									...
									'px',
								top:
									this.options.dialRadius - Math.cos(radian) * this.options.outerRadius - this.options.tickRadius + 'px'
							});
			...
			[
				{
					key: 'init',
					value: function init(els, options) {
						return _get(Timepicker.__proto__ || Object.getPrototypeOf(Timepicker), 'init', this).call(
							this,
							this,
							els,
							options
			...
			[
				{
					key: 'init',
					value: function init(els, options) {
						return _get(CharacterCounter.__proto__ || Object.getPrototypeOf(CharacterCounter), 'init', this).call(
							this,
							this,
							els,
							options
			...
			[
				{
					key: 'init',
					value: function init(els, options) {
						return _get(Carousel.__proto__ || Object.getPrototypeOf(Carousel), 'init', this).call(
							this,
							this,
							els,
							options
			...
			[
				{
					key: 'init',
					value: function init(els, options) {
						return _get(TapTarget.__proto__ || Object.getPrototypeOf(TapTarget), 'init', this).call(
							this,
							this,
							els,
							options
			...
			[
				{
					key: 'init',
					value: function init(els, options) {
						return _get(FormSelect.__proto__ || Object.getPrototypeOf(FormSelect), 'init', this).call(
							this,
							this,
							els,
							options
